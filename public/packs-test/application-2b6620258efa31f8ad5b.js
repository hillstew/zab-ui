...
var _class = function (_Controller) {
  ...
  _createClass(_class, [{
    ...
    key: "calculateSnowball",
    value: function calculateSnowball(event) {
      event.preventDefault();
      console.log(event);
      var amount = event.target.previousSibling.previousSibling.valueAsNumber;

      fetch("/snowball/" + amount).then(function (response) {
      ...
      var account_1 = document.querySelector("#account1");
...
/***/ })
/******/ ]);
//# sourceMappingURL=application-2b6620258efa31f8ad5b.js.map